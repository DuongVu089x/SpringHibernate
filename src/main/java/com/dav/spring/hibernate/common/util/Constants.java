package com.dav.spring.hibernate.common.util;
...
public class Constants {
	...
	/** The Constant STR_STUDENT. */
	public static final String STR_STUDENT = "student";

	/** The Constant STR_MESSAGE. */
	public static final String STR_MESSAGE = "message";

	/** The Constant STR_USERNAME. */
	public static final String STR_USERNAME = "username";

	/** The Constant STR_ROLE. */
	...
	/** The Constant STR_JWT. */
	public static final String STR_JWT = "jwt";

	/** The Constant STR_CLAZZ. */
	public static final String STR_CLAZZ = "clazz";

	/** The Constant STR_CLASS. */
	...
	/** The Constant STR_URL_DEFAULT. */
	public static final String STR_URL_DEFAULT = "/student/";
